...
var MultiMenuWrapper = exports.MultiMenuWrapper = function (_Component2) {
  ...
  _createClass(MultiMenuWrapper, [{
    ...
    value: function render() {
      ...
      var maxHeight = window.innerHeight - position.top - WINDOW_PAD;

      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)('multi-menu-wrapper', 'expand-' + expandDirection, className, { 'multi-menu-wrapper-attached': isStyledMenu }),
          style: position
        },
...
var MultiMenu = exports.MultiMenu = function (_Component3) {
  ...
  function MultiMenu() {
    ...
    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref = MultiMenu.__proto__ || Object.getPrototypeOf(MultiMenu)).call.apply(_ref, [this].concat(args))), _this3), _this3.renderOpenMenu = function (menu) {
      if (!_this3._el) {
        return null;
      }

      var _this3$props = _this3.props,
          basePath = _this3$props.basePath,
          openPath = _this3$props.openPath,
          onHover = _this3$props.onHover,
      ...
      var scrollTop = _this3._el.scrollTop;
      var offsetTop = _this3._el.getBoundingClientRect().top;
      var calculatedHeight = (0, _sizing.getMenuHeight)(openMenu);
      var currentItemOffset = (0, _sizing.getMenuItemOffset)(menu, openIndex);
...
var MenuItem = exports.MenuItem = function (_Component4) {
  ...
  function MenuItem() {
    ...
    return _ret2 = (_temp2 = (_this4 = _possibleConstructorReturn(this, (_ref2 = MenuItem.__proto__ || Object.getPrototypeOf(MenuItem)).call.apply(_ref2, [this].concat(args))), _this4), _this4.handleClick = function (e) {
...
var MultiMenuTrigger = exports.MultiMenuTrigger = function (_Component5) {
  ...
  function MultiMenuTrigger() {
    ...
    return _ret3 = (_temp3 = (_this5 = _possibleConstructorReturn(this, (_ref3 = MultiMenuTrigger.__proto__ || Object.getPrototypeOf(MultiMenuTrigger)).call.apply(_ref3, [this].concat(args))), _this5), _this5.state = {
      expanded: false,
      position: null,
...
var MenuPortal = function (_Component6) {
  _inherits(MenuPortal, _Component6);
  ...
  _createClass(MenuPortal, [{
    ...
    value: function componentWillUnmount() {
      ...
      window.setTimeout(function () {
        ...
        document.body.removeChild(_this7._node);
        _this7._node = null;
      }, 0);
    }
  }, {
