...
exports.MultiMenuTrigger = exports.MenuItem = exports.MenuSpacer = exports.MultiMenu = exports.MultiSelectMenu = exports.matches = undefined;
...
var MultiSelectMenu = exports.MultiSelectMenu = function (_Component) {
  ...
  _createClass(MultiSelectMenu, [{
    ...
    value: function render() {
      ...
      var label = selectedOption ? selectedOption.label : 'Select...';
...
var MultiMenuWrapper = function (_Component2) {
  ...
  _createClass(MultiMenuTrigger, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)('multi-menu-trigger', className, { expanded: expanded }),
          ref: this.elementRef
        },
