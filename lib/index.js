...
var MultiSelectMenu = function (_Component) {
  ...
  _createClass(MultiSelectMenu, [{
    ...
    value: function render() {
      ...
      var title = typeof label === 'string' ? label : undefined;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'multi-select-menu-selection', title: title },
          _react2.default.createElement(
            'span',
  ...
  _createClass(MultiMenuWrapper, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactDocumentEvents2.default, { onKeyDown: this.handleKeyDown }),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          overflowBefore ? _react2.default.createElement(OverflowControl, {
            direction: 'up',
            onScroll: this.handleOverflowScroll
          }) : null,
          overflowAfter ? _react2.default.createElement(OverflowControl, {
            direction: 'down',
            onScroll: this.handleOverflowScroll
          }) : null
        ),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderOpenMenu = function () {
    ...
    var _props7 = _this9.props,
        ...
        nested = _props7.nested,
        childWidth = _props7.childWidth;
    ...
    try {
      for (var _iterator2 = menu[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        if (itm && itm.children && itm.inline) {
          var parentItem = _extends({}, itm, {
            indent: indent,
            children: null,
            subtitle: null
          });

          var _menu = itm.children;

          result = result.concat([parentItem].concat(_this9.evaluateMenuSub({ menu: _menu }, indent + 1)));
        } else {
          result.push(itm ? _extends({}, itm, { indent: indent }) : itm);
        }
      }
    } catch (err) {
  ...
  this.evaluateMenu = function (props) {
    _this9._evaluatedMenu = _this9.evaluateMenuSub(props);
  };
...
var MenuItem = exports.MenuItem = function (_Component5) {
  ...
  function MenuItem() {
    ...
    return _ret2 = (_temp2 = (_this5 = _possibleConstructorReturn(this, (_ref2 = MenuItem.__proto__ || Object.getPrototypeOf(MenuItem)).call.apply(_ref2, [this].concat(args))), _this5), _this5.handleClick = function (e) {
      ...
      return children && _this5.getChildren().length > 0 && !inline;
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      ...
      var title = typeof data.label === 'string' ? data.label : undefined;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'multi-menu-item-label', title: title },
            data.label,
            data.subtitle && !inline ? _react2.default.createElement(
              'span',
...
var MultiMenuTrigger = exports.MultiMenuTrigger = function (_Component6) {
  ...
  function MultiMenuTrigger() {
    ...
    return _ret3 = (_temp3 = (_this6 = _possibleConstructorReturn(this, (_ref3 = MultiMenuTrigger.__proto__ || Object.getPrototypeOf(MultiMenuTrigger)).call.apply(_ref3, [this].concat(args))), _this6), _this6.state = {
      ...
      verticalExpand: EXPAND_DOWN
    }, _this6.getMenuWidth = function () {
      var width = _this6.props.width;
      ...
      var menuWidth = _this6.getMenuWidth();
      ...
      if (_this6.element) {
        ...
        if (verticalExpand === EXPAND_UP) {
          position = {
            bottom: windowHeight - rect.top + _sizing.MENU_PAD,
            width: menuWidth
          };
        } else {
          position = { top: rect.bottom + _sizing.MENU_PAD, width: menuWidth };
        }
